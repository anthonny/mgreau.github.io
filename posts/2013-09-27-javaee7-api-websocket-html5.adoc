...
<3> POJO représentant les types de messages échangés entre peers
...
<3> les 2 encoders permettent de transformer les POJO 'MatchMessage' et 'BetMessage' en flux JSON
