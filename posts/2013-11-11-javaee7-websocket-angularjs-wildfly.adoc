...
WilFly uses its new Web Server called {http://undertow.io}[Undertow] which is the replacing of Tomcat.

[TIP]
====
'I didn't test this application on Glassfish 4, but since I'm using only Java EE 7 API dependencies, it could work with the same code without problem.'
====
