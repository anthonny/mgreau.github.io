...
gem 'asciidoctor', '>= 0.1.4.rc1'                           # If using AsciiDoc syntax, need 0.1.1 for Header support
gem 'coderay', '>= 1.0.9'                               # If using AsciiDoctor >= 0.1.4, need coderay  1.0.9 for highlight
...
gem "erubis", "~> 2.7.0"                                # use by asciidoc
